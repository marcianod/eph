...
*   **Next.js:** A React framework for building server-side rendered and statically generated web applications (v15.5.9).
*   **React:** A JavaScript library for building user interfaces (v19.1.0).
*   **TypeScript:** A typed superset of JavaScript that compiles to plain JavaScript.

## Styling:

*   **Tailwind CSS:** A utility-first CSS framework for rapidly building custom designs (v4).
...
*   **MongoDB Atlas:** Use for storing duel metadata, game results, and vector embeddings for similarity searches.
